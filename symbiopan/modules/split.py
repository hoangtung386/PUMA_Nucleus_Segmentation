...
def make_or_load_group_split_with_test(
    ...
    train_sources = {str(x) for x in ordered_sources[:n_train].tolist()}
    val_sources = {str(x) for x in ordered_sources[n_train : n_train + n_val].tolist()}
    test_sources = {str(x) for x in ordered_sources[n_train + n_val :].tolist()}
...
__all__ = ["make_or_load_group_split", "make_or_load_group_split_with_test"]
