...
class ParallelDecoders(nn.Module):
    def __init__(
        ...
        self.boundary_attn = BoundaryAttentionModule(fpn_dim=fpn_dim)
    ...
    def forward(
        ...
        boundary_map = self.boundary_attn(p1)

        return tissue_logits, np_logits, nc_logits, hv_logits, boundary_map
